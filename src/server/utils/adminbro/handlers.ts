...
import { Action, RecordActionResponse } from 'admin-bro/lib/backend/actions/action.interface';

const customNew = async (request, response, context): Action<RecordActionResponse> => {
